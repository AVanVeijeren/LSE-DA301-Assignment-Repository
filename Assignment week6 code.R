...
setwd('C:/Users/Alexandra/OneDrive/LSE Data Analytics/Course 3/Testing Assignment data/LSE_DA301_assignment_files')
...
# Save a copy of the cleaned data before removing outliers. 
...
## A log transformation on the independent variables did not resolve
## the non-normality of the residuals which implies that a different
